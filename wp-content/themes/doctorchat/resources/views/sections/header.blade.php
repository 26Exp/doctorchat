...
<a href="https://app.doctorchat.md/registration-flow/select-doctor?doctor_id={{ get_field('app_id') }}@if(get_current_blog_id() == 2)&locale=ru @endif" rel="nofollow">
  <button id="request-consultation" class="fixed left-1/2 bottom-8 -translate-x-1/2 text-base whitespace-nowrap rounded-full py-4 px-8 bg-doctorchat-red text-white flex items-center justify-center z-50 shadow-lg sm:-translate-x-0 sm:left-auto sm:right-8 md:bottom-10 md:right-12 md:text-lg">
