...
@section('content')
    <!-- Hero Section Start -->
    <section class="relative h-screen bg-cover bg-[center_right_25%] bg-no-repeat pt-[10vh] md:bg-center"
        ...
        <div class="dc-container">
            ...
            <main class="how-works-section">
                ...
                <div class="how-works-block">
                    ...
                    <div class="preview">
                        <img src="{{ get_field('select_doctor')['image'] }}"
                            alt="{{ get_field('select_doctor')['heading'] }}" />
                    </div>
                </div>
                <div class="how-works-block">
                    <div class="caption">
                    ...
                    <div class="preview">
                        <img src="{{ get_field('describe_problem')['image'] }}"
                            alt="{{ get_field('describe_problem')['heading'] }}" />
                    </div>
                </div>
                <div class="how-works-block">
                    <div class="caption">
                    ...
                    <div class="preview">
                        <img src="{{ get_field('complete_investigation')['image'] }}"
                            alt="{{ get_field('complete_investigation')['heading'] }}" />
                    </div>
                </div>
                <div class="how-works-block">
                    <div class="caption">
    ...
    <!-- Banner Start -->
    <section class="banner relative bg-cover bg-[center_right_25%] bg-no-repeat md:bg-center"
