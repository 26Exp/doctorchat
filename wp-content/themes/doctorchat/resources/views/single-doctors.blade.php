...
{{--                        </div>--}}
{{--                    </div>--}}
                    <a rel="nofollow" href="https://app.doctorchat@if(get_current_blog_id() == 5).ro@else.md@endif/registration-flow/select-doctor?doctor_id={{ get_field('app_id') }}&locale={{ get_field('app_locale', 'options') }}">
